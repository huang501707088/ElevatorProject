...
public class HttpClientUtil {
    ...
    //private final static String  url="http://120.24.216.230:8888/xtc/t.do";
    public final static String url = Constant.baseUrl+"/dtjyzdc/json.html";
   // public final static String url = "http://192.168.0.96:8105/hbtc/json.html";
   // private final static String pay_url = "http://pay.xtkeji.net/psp/clientpay.do";
   // private final static String posturl = "http://192.168.0.96:8105/hbtc/UploadServletService";
    private final static String posturl = Constant.baseUrl+"/hbtc/UploadServletService";
    ...
    public static String getGetBaseResult(String url) {
        ...
        try{
            ...
            httpClient.getParams().setIntParameter(url, Constant.SERVER_TIME_OUT);
    ...
    // 保存session信息
    /*private static void saveSession(CookieStore cookieStore) {
        // TODO Auto-generated method stub
