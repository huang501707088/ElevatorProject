...
//									startActivity(intent);
	...
	class mBroadcastReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context arg0, Intent arg1) {
			...
			Toast.makeText(getApplicationContext(), "TriggerRescueActivity Get Button,Duration="+bundle.getString("Duration"), Toast.LENGTH_SHORT).show();
			abortBroadcast();
			System.out.println("TriggerRescueActivity Get Button,Duration="+bundle.getString("Duration"));
			if("long".equals(bundle.getString("Duration"))){
				mCoundDownTimer.cancel();
				System.out.println("Trigger Timer cancel");
				Intent intent = new Intent(TriggerRescueActivity.this,
						ConfirmRescueActivity.class);
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		System.out.println("TriggerRescueActivity onDestroy");
		myFinish();
	}
	@Override
	protected void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		System.out.println("TriggerRescueActivity onStop");
		clearReceiver();
	}
	@Override
	protected void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
		System.out.println("TriggerRescueActivity onStart");
		setReceiver();
	}
	@Override
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		System.out.println("TriggerRescueActivity onPause");
		myFinish();
	}
	@Override
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onPause();
		System.out.println("TriggerRescueActivity onResume");
	}
	void setReceiver(){
